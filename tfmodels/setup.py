...
# This file is created by @mburaksayici in order to install research models.
...
project_name = 'tf_models_research'
...
setup(
    name=project_name,
    version=version,
    description='TensorFlow Official Models for Research',

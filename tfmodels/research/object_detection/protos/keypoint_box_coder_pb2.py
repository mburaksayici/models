...
_KEYPOINTBOXCODER = _descriptor.Descriptor(
  ...
  full_name='tfmodels.research.object_detection.protos.KeypointBoxCoder',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_keypoints', full_name='tfmodels.research.object_detection.protos.KeypointBoxCoder.num_keypoints', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='y_scale', full_name='tfmodels.research.object_detection.protos.KeypointBoxCoder.y_scale', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='x_scale', full_name='tfmodels.research.object_detection.protos.KeypointBoxCoder.x_scale', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height_scale', full_name='tfmodels.research.object_detection.protos.KeypointBoxCoder.height_scale', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='width_scale', full_name='tfmodels.research.object_detection.protos.KeypointBoxCoder.width_scale', index=4,
...
KeypointBoxCoder = _reflection.GeneratedProtocolMessageType('KeypointBoxCoder', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.keypoint_box_coder_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.KeypointBoxCoder)
  ))

...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n-object_detection/protos/target_assigner.proto\x12\x17object_detection.protos\x1a\'object_detection/protos/box_coder.proto\x1a%object_detection/protos/matcher.proto\x1a:object_detection/protos/region_similarity_calculator.proto\"\xcd\x01\n\x0eTargetAssigner\x12\x31\n\x07matcher\x18\x01 \x01(\x0b\x32 .tfmodels.research.object_detection.protos.Matcher\x12R\n\x15similarity_calculator\x18\x02 \x01(\x0b\x32\x33.tfmodels.research.object_detection.protos.RegionSimilarityCalculator\x12\x34\n\tbox_coder\x18\x03 \x01(\x0b\x32!.tfmodels.research.object_detection.protos.BoxCoder')
  ,
...
_TARGETASSIGNER = _descriptor.Descriptor(
  name='TargetAssigner',
  full_name='tfmodels.research.object_detection.protos.TargetAssigner',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='matcher', full_name='tfmodels.research.object_detection.protos.TargetAssigner.matcher', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='similarity_calculator', full_name='tfmodels.research.object_detection.protos.TargetAssigner.similarity_calculator', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='box_coder', full_name='tfmodels.research.object_detection.protos.TargetAssigner.box_coder', index=2,
...
TargetAssigner = _reflection.GeneratedProtocolMessageType('TargetAssigner', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.target_assigner_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.TargetAssigner)
  ))

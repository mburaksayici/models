...
from tfmodels.research.object_detection.protos import faster_rcnn_box_coder_pb2 as object__detection_dot_protos_dot_faster__rcnn__box__coder__pb2
from tfmodels.research.object_detection.protos import keypoint_box_coder_pb2 as object__detection_dot_protos_dot_keypoint__box__coder__pb2
from tfmodels.research.object_detection.protos import mean_stddev_box_coder_pb2 as object__detection_dot_protos_dot_mean__stddev__box__coder__pb2
from tfmodels.research.object_detection.protos import square_box_coder_pb2 as object__detection_dot_protos_dot_square__box__coder__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\'object_detection/protos/box_coder.proto\x12\x17object_detection.protos\x1a\x33object_detection/protos/faster_rcnn_box_coder.proto\x1a\x30object_detection/protos/keypoint_box_coder.proto\x1a\x33object_detection/protos/mean_stddev_box_coder.proto\x1a.object_detection/protos/square_box_coder.proto\"\xc7\x02\n\x08\x42oxCoder\x12L\n\x15\x66\x61ster_rcnn_box_coder\x18\x01 \x01(\x0b\x32+.tfmodels.research.object_detection.protos.FasterRcnnBoxCoderH\x00\x12L\n\x15mean_stddev_box_coder\x18\x02 \x01(\x0b\x32+.tfmodels.research.object_detection.protos.MeanStddevBoxCoderH\x00\x12\x43\n\x10square_box_coder\x18\x03 \x01(\x0b\x32\'.tfmodels.research.object_detection.protos.SquareBoxCoderH\x00\x12G\n\x12keypoint_box_coder\x18\x04 \x01(\x0b\x32).tfmodels.research.object_detection.protos.KeypointBoxCoderH\x00\x42\x11\n\x0f\x62ox_coder_oneof')
  ,
...
_BOXCODER = _descriptor.Descriptor(
  name='BoxCoder',
  full_name='tfmodels.research.object_detection.protos.BoxCoder',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='faster_rcnn_box_coder', full_name='tfmodels.research.object_detection.protos.BoxCoder.faster_rcnn_box_coder', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='mean_stddev_box_coder', full_name='tfmodels.research.object_detection.protos.BoxCoder.mean_stddev_box_coder', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='square_box_coder', full_name='tfmodels.research.object_detection.protos.BoxCoder.square_box_coder', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keypoint_box_coder', full_name='tfmodels.research.object_detection.protos.BoxCoder.keypoint_box_coder', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='box_coder_oneof', full_name='tfmodels.research.object_detection.protos.BoxCoder.box_coder_oneof',
...
BoxCoder = _reflection.GeneratedProtocolMessageType('BoxCoder', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.box_coder_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.BoxCoder)
  ))

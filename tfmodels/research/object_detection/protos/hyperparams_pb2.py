...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n)object_detection/protos/hyperparams.proto\x12\x17object_detection.protos\"\xe5\x04\n\x0bHyperparams\x12\x39\n\x02op\x18\x01 \x01(\x0e\x32\'.tfmodels.research.object_detection.protos.Hyperparams.Op:\x04\x43ONV\x12\x39\n\x0bregularizer\x18\x02 \x01(\x0b\x32$.tfmodels.research.object_detection.protos.Regularizer\x12\x39\n\x0binitializer\x18\x03 \x01(\x0b\x32$.tfmodels.research.object_detection.protos.Initializer\x12I\n\nactivation\x18\x04 \x01(\x0e\x32/.tfmodels.research.object_detection.protos.Hyperparams.Activation:\x04RELU\x12\x38\n\nbatch_norm\x18\x05 \x01(\x0b\x32\".tfmodels.research.object_detection.protos.BatchNormH\x00\x12=\n\x0fsync_batch_norm\x18\t \x01(\x0b\x32\".tfmodels.research.object_detection.protos.BatchNormH\x00\x12\x38\n\ngroup_norm\x18\x07 \x01(\x0b\x32\".tfmodels.research.object_detection.protos.GroupNormH\x00\x12#\n\x14regularize_depthwise\x18\x06 \x01(\x08:\x05\x66\x61lse\x12\x1d\n\x0e\x66orce_use_bias\x18\x08 \x01(\x08:\x05\x66\x61lse\"\x16\n\x02Op\x12\x08\n\x04\x43ONV\x10\x01\x12\x06\n\x02\x46\x43\x10\x02\"7\n\nActivation\x12\x08\n\x04NONE\x10\x00\x12\x08\n\x04RELU\x10\x01\x12\n\n\x06RELU_6\x10\x02\x12\t\n\x05SWISH\x10\x03\x42\x12\n\x10normalizer_oneof\"\xa6\x01\n\x0bRegularizer\x12@\n\x0el1_regularizer\x18\x01 \x01(\x0b\x32&.tfmodels.research.object_detection.protos.L1RegularizerH\x00\x12@\n\x0el2_regularizer\x18\x02 \x01(\x0b\x32&.tfmodels.research.object_detection.protos.L2RegularizerH\x00\x42\x13\n\x11regularizer_oneof\"\"\n\rL1Regularizer\x12\x11\n\x06weight\x18\x01 \x01(\x02:\x01\x31\"\"\n\rL2Regularizer\x12\x11\n\x06weight\x18\x01 \x01(\x02:\x01\x31\"\xd8\x02\n\x0bInitializer\x12[\n\x1ctruncated_normal_initializer\x18\x01 \x01(\x0b\x32\x33.tfmodels.research.object_detection.protos.TruncatedNormalInitializerH\x00\x12[\n\x1cvariance_scaling_initializer\x18\x02 \x01(\x0b\x32\x33.tfmodels.research.object_detection.protos.VarianceScalingInitializerH\x00\x12U\n\x19random_normal_initializer\x18\x03 \x01(\x0b\x32\x30.tfmodels.research.object_detection.protos.RandomNormalInitializerH\x00\x12#\n\x19keras_initializer_by_name\x18\x04 \x01(\tH\x00\x42\x13\n\x11initializer_oneof\"@\n\x1aTruncatedNormalInitializer\x12\x0f\n\x04mean\x18\x01 \x01(\x02:\x01\x30\x12\x11\n\x06stddev\x18\x02 \x01(\x02:\x01\x31\"\xc5\x01\n\x1aVarianceScalingInitializer\x12\x11\n\x06\x66\x61\x63tor\x18\x01 \x01(\x02:\x01\x32\x12\x16\n\x07uniform\x18\x02 \x01(\x08:\x05\x66\x61lse\x12N\n\x04mode\x18\x03 \x01(\x0e\x32\x38.tfmodels.research.object_detection.protos.VarianceScalingInitializer.Mode:\x06\x46\x41N_IN\",\n\x04Mode\x12\n\n\x06\x46\x41N_IN\x10\x00\x12\x0b\n\x07\x46\x41N_OUT\x10\x01\x12\x0b\n\x07\x46\x41N_AVG\x10\x02\"=\n\x17RandomNormalInitializer\x12\x0f\n\x04mean\x18\x01 \x01(\x02:\x01\x30\x12\x11\n\x06stddev\x18\x02 \x01(\x02:\x01\x31\"z\n\tBatchNorm\x12\x14\n\x05\x64\x65\x63\x61y\x18\x01 \x01(\x02:\x05\x30.999\x12\x14\n\x06\x63\x65nter\x18\x02 \x01(\x08:\x04true\x12\x14\n\x05scale\x18\x03 \x01(\x08:\x05\x66\x61lse\x12\x16\n\x07\x65psilon\x18\x04 \x01(\x02:\x05\x30.001\x12\x13\n\x05train\x18\x05 \x01(\x08:\x04true\"\x0b\n\tGroupNorm')
)
...
_HYPERPARAMS_OP = _descriptor.EnumDescriptor(
  name='Op',
  full_name='tfmodels.research.object_detection.protos.Hyperparams.Op',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_HYPERPARAMS_ACTIVATION = _descriptor.EnumDescriptor(
  name='Activation',
  full_name='tfmodels.research.object_detection.protos.Hyperparams.Activation',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_VARIANCESCALINGINITIALIZER_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='tfmodels.research.object_detection.protos.VarianceScalingInitializer.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_HYPERPARAMS = _descriptor.Descriptor(
  name='Hyperparams',
  full_name='tfmodels.research.object_detection.protos.Hyperparams',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='op', full_name='tfmodels.research.object_detection.protos.Hyperparams.op', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='regularizer', full_name='tfmodels.research.object_detection.protos.Hyperparams.regularizer', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='initializer', full_name='tfmodels.research.object_detection.protos.Hyperparams.initializer', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='activation', full_name='tfmodels.research.object_detection.protos.Hyperparams.activation', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='batch_norm', full_name='tfmodels.research.object_detection.protos.Hyperparams.batch_norm', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sync_batch_norm', full_name='tfmodels.research.object_detection.protos.Hyperparams.sync_batch_norm', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='group_norm', full_name='tfmodels.research.object_detection.protos.Hyperparams.group_norm', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='regularize_depthwise', full_name='tfmodels.research.object_detection.protos.Hyperparams.regularize_depthwise', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='force_use_bias', full_name='tfmodels.research.object_detection.protos.Hyperparams.force_use_bias', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='normalizer_oneof', full_name='tfmodels.research.object_detection.protos.Hyperparams.normalizer_oneof',
...
_REGULARIZER = _descriptor.Descriptor(
  name='Regularizer',
  full_name='tfmodels.research.object_detection.protos.Regularizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='l1_regularizer', full_name='tfmodels.research.object_detection.protos.Regularizer.l1_regularizer', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='l2_regularizer', full_name='tfmodels.research.object_detection.protos.Regularizer.l2_regularizer', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='regularizer_oneof', full_name='tfmodels.research.object_detection.protos.Regularizer.regularizer_oneof',
      index=0, containing_type=None, fields=[]),
  ],
...
_L1REGULARIZER = _descriptor.Descriptor(
  name='L1Regularizer',
  full_name='tfmodels.research.object_detection.protos.L1Regularizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weight', full_name='tfmodels.research.object_detection.protos.L1Regularizer.weight', index=0,
...
_L2REGULARIZER = _descriptor.Descriptor(
  name='L2Regularizer',
  full_name='tfmodels.research.object_detection.protos.L2Regularizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weight', full_name='tfmodels.research.object_detection.protos.L2Regularizer.weight', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INITIALIZER = _descriptor.Descriptor(
  name='Initializer',
  full_name='tfmodels.research.object_detection.protos.Initializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='truncated_normal_initializer', full_name='tfmodels.research.object_detection.protos.Initializer.truncated_normal_initializer', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='variance_scaling_initializer', full_name='tfmodels.research.object_detection.protos.Initializer.variance_scaling_initializer', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_normal_initializer', full_name='tfmodels.research.object_detection.protos.Initializer.random_normal_initializer', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keras_initializer_by_name', full_name='tfmodels.research.object_detection.protos.Initializer.keras_initializer_by_name', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='initializer_oneof', full_name='tfmodels.research.object_detection.protos.Initializer.initializer_oneof',
      index=0, containing_type=None, fields=[]),
  ],
...
_TRUNCATEDNORMALINITIALIZER = _descriptor.Descriptor(
  ...
  full_name='tfmodels.research.object_detection.protos.TruncatedNormalInitializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='mean', full_name='tfmodels.research.object_detection.protos.TruncatedNormalInitializer.mean', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stddev', full_name='tfmodels.research.object_detection.protos.TruncatedNormalInitializer.stddev', index=1,
...
_VARIANCESCALINGINITIALIZER = _descriptor.Descriptor(
  ...
  full_name='tfmodels.research.object_detection.protos.VarianceScalingInitializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='factor', full_name='tfmodels.research.object_detection.protos.VarianceScalingInitializer.factor', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='uniform', full_name='tfmodels.research.object_detection.protos.VarianceScalingInitializer.uniform', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mode', full_name='tfmodels.research.object_detection.protos.VarianceScalingInitializer.mode', index=2,
...
_RANDOMNORMALINITIALIZER = _descriptor.Descriptor(
  ...
  full_name='tfmodels.research.object_detection.protos.RandomNormalInitializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='mean', full_name='tfmodels.research.object_detection.protos.RandomNormalInitializer.mean', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stddev', full_name='tfmodels.research.object_detection.protos.RandomNormalInitializer.stddev', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BATCHNORM = _descriptor.Descriptor(
  name='BatchNorm',
  full_name='tfmodels.research.object_detection.protos.BatchNorm',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='decay', full_name='tfmodels.research.object_detection.protos.BatchNorm.decay', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='center', full_name='tfmodels.research.object_detection.protos.BatchNorm.center', index=1,
      number=2, type=8, cpp_type=7, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='scale', full_name='tfmodels.research.object_detection.protos.BatchNorm.scale', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='epsilon', full_name='tfmodels.research.object_detection.protos.BatchNorm.epsilon', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='train', full_name='tfmodels.research.object_detection.protos.BatchNorm.train', index=4,
...
_GROUPNORM = _descriptor.Descriptor(
  name='GroupNorm',
  full_name='tfmodels.research.object_detection.protos.GroupNorm',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
Hyperparams = _reflection.GeneratedProtocolMessageType('Hyperparams', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.Hyperparams)
  ))
...
Regularizer = _reflection.GeneratedProtocolMessageType('Regularizer', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.Regularizer)
  ))
...
L1Regularizer = _reflection.GeneratedProtocolMessageType('L1Regularizer', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.L1Regularizer)
  ))
...
L2Regularizer = _reflection.GeneratedProtocolMessageType('L2Regularizer', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.L2Regularizer)
  ))
...
Initializer = _reflection.GeneratedProtocolMessageType('Initializer', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.Initializer)
  ))
...
TruncatedNormalInitializer = _reflection.GeneratedProtocolMessageType('TruncatedNormalInitializer', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.TruncatedNormalInitializer)
  ))
...
VarianceScalingInitializer = _reflection.GeneratedProtocolMessageType('VarianceScalingInitializer', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.VarianceScalingInitializer)
  ))
...
RandomNormalInitializer = _reflection.GeneratedProtocolMessageType('RandomNormalInitializer', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.RandomNormalInitializer)
  ))
...
BatchNorm = _reflection.GeneratedProtocolMessageType('BatchNorm', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.BatchNorm)
  ))
...
GroupNorm = _reflection.GeneratedProtocolMessageType('GroupNorm', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.GroupNorm)
  ))

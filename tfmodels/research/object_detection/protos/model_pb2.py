...
from tfmodels.research.object_detection.protos import center_net_pb2 as object__detection_dot_protos_dot_center__net__pb2
from tfmodels.research.object_detection.protos import faster_rcnn_pb2 as object__detection_dot_protos_dot_faster__rcnn__pb2
from tfmodels.research.object_detection.protos import ssd_pb2 as object__detection_dot_protos_dot_ssd__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n#object_detection/protos/model.proto\x12\x17object_detection.protos\x1a(object_detection/protos/center_net.proto\x1a)object_detection/protos/faster_rcnn.proto\x1a!object_detection/protos/ssd.proto\"\x86\x02\n\x0e\x44\x65tectionModel\x12:\n\x0b\x66\x61ster_rcnn\x18\x01 \x01(\x0b\x32#.tfmodels.research.object_detection.protos.FasterRcnnH\x00\x12+\n\x03ssd\x18\x02 \x01(\x0b\x32\x1c.tfmodels.research.object_detection.protos.SsdH\x00\x12H\n\x12\x65xperimental_model\x18\x03 \x01(\x0b\x32*.tfmodels.research.object_detection.protos.ExperimentalModelH\x00\x12\x38\n\ncenter_net\x18\x04 \x01(\x0b\x32\".tfmodels.research.object_detection.protos.CenterNetH\x00\x42\x07\n\x05model\"!\n\x11\x45xperimentalModel\x12\x0c\n\x04name\x18\x01 \x01(\t')
  ,
...
_DETECTIONMODEL = _descriptor.Descriptor(
  name='DetectionModel',
  full_name='tfmodels.research.object_detection.protos.DetectionModel',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='faster_rcnn', full_name='tfmodels.research.object_detection.protos.DetectionModel.faster_rcnn', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='ssd', full_name='tfmodels.research.object_detection.protos.DetectionModel.ssd', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='experimental_model', full_name='tfmodels.research.object_detection.protos.DetectionModel.experimental_model', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='center_net', full_name='tfmodels.research.object_detection.protos.DetectionModel.center_net', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='model', full_name='tfmodels.research.object_detection.protos.DetectionModel.model',
...
_EXPERIMENTALMODEL = _descriptor.Descriptor(
  ...
  full_name='tfmodels.research.object_detection.protos.ExperimentalModel',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='tfmodels.research.object_detection.protos.ExperimentalModel.name', index=0,
...
DetectionModel = _reflection.GeneratedProtocolMessageType('DetectionModel', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.model_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.DetectionModel)
  ))
...
ExperimentalModel = _reflection.GeneratedProtocolMessageType('ExperimentalModel', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.model_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.ExperimentalModel)
  ))

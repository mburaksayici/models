...
from tfmodels.research.object_detection.protos import argmax_matcher_pb2 as object__detection_dot_protos_dot_argmax__matcher__pb2
from tfmodels.research.object_detection.protos import bipartite_matcher_pb2 as object__detection_dot_protos_dot_bipartite__matcher__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n%object_detection/protos/matcher.proto\x12\x17object_detection.protos\x1a,object_detection/protos/argmax_matcher.proto\x1a/object_detection/protos/bipartite_matcher.proto\"\xa4\x01\n\x07Matcher\x12@\n\x0e\x61rgmax_matcher\x18\x01 \x01(\x0b\x32&.tfmodels.research.object_detection.protos.ArgMaxMatcherH\x00\x12\x46\n\x11\x62ipartite_matcher\x18\x02 \x01(\x0b\x32).tfmodels.research.object_detection.protos.BipartiteMatcherH\x00\x42\x0f\n\rmatcher_oneof')
  ,
...
_MATCHER = _descriptor.Descriptor(
  name='Matcher',
  full_name='tfmodels.research.object_detection.protos.Matcher',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='argmax_matcher', full_name='tfmodels.research.object_detection.protos.Matcher.argmax_matcher', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='bipartite_matcher', full_name='tfmodels.research.object_detection.protos.Matcher.bipartite_matcher', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='matcher_oneof', full_name='tfmodels.research.object_detection.protos.Matcher.matcher_oneof',
...
Matcher = _reflection.GeneratedProtocolMessageType('Matcher', (_message.Message,), dict(
  DESCRIPTOR = _MATCHER,
  __module__ = 'tfmodels.research.object_detection.protos.matcher_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.Matcher)
  ))

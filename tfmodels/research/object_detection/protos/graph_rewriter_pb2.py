...
_GRAPHREWRITER = _descriptor.Descriptor(
  name='GraphRewriter',
  full_name='tfmodels.research.object_detection.protos.GraphRewriter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='quantization', full_name='tfmodels.research.object_detection.protos.GraphRewriter.quantization', index=0,
...
_QUANTIZATION = _descriptor.Descriptor(
  name='Quantization',
  full_name='tfmodels.research.object_detection.protos.Quantization',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='delay', full_name='tfmodels.research.object_detection.protos.Quantization.delay', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weight_bits', full_name='tfmodels.research.object_detection.protos.Quantization.weight_bits', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='activation_bits', full_name='tfmodels.research.object_detection.protos.Quantization.activation_bits', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='symmetric', full_name='tfmodels.research.object_detection.protos.Quantization.symmetric', index=3,
...
GraphRewriter = _reflection.GeneratedProtocolMessageType('GraphRewriter', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.graph_rewriter_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.GraphRewriter)
  ))
...
Quantization = _reflection.GeneratedProtocolMessageType('Quantization', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.graph_rewriter_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.Quantization)
  ))

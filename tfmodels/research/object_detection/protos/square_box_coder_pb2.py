...
_SQUAREBOXCODER = _descriptor.Descriptor(
  name='SquareBoxCoder',
  full_name='tfmodels.research.object_detection.protos.SquareBoxCoder',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='y_scale', full_name='tfmodels.research.object_detection.protos.SquareBoxCoder.y_scale', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='x_scale', full_name='tfmodels.research.object_detection.protos.SquareBoxCoder.x_scale', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='length_scale', full_name='tfmodels.research.object_detection.protos.SquareBoxCoder.length_scale', index=2,
...
SquareBoxCoder = _reflection.GeneratedProtocolMessageType('SquareBoxCoder', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.square_box_coder_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.SquareBoxCoder)
  ))

...
from tfmodels.research.object_detection.protos import flexible_grid_anchor_generator_pb2 as object__detection_dot_protos_dot_flexible__grid__anchor__generator__pb2
from tfmodels.research.object_detection.protos import grid_anchor_generator_pb2 as object__detection_dot_protos_dot_grid__anchor__generator__pb2
from tfmodels.research.object_detection.protos import multiscale_anchor_generator_pb2 as object__detection_dot_protos_dot_multiscale__anchor__generator__pb2
from tfmodels.research.object_detection.protos import ssd_anchor_generator_pb2 as object__detection_dot_protos_dot_ssd__anchor__generator__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n.object_detection/protos/anchor_generator.proto\x12\x17object_detection.protos\x1a<object_detection/protos/flexible_grid_anchor_generator.proto\x1a\x33object_detection/protos/grid_anchor_generator.proto\x1a\x39object_detection/protos/multiscale_anchor_generator.proto\x1a\x32object_detection/protos/ssd_anchor_generator.proto\"\x82\x03\n\x0f\x41nchorGenerator\x12M\n\x15grid_anchor_generator\x18\x01 \x01(\x0b\x32,.tfmodels.research.object_detection.protos.GridAnchorGeneratorH\x00\x12K\n\x14ssd_anchor_generator\x18\x02 \x01(\x0b\x32+.tfmodels.research.object_detection.protos.SsdAnchorGeneratorH\x00\x12Y\n\x1bmultiscale_anchor_generator\x18\x03 \x01(\x0b\x32\x32.tfmodels.research.object_detection.protos.MultiscaleAnchorGeneratorH\x00\x12^\n\x1e\x66lexible_grid_anchor_generator\x18\x04 \x01(\x0b\x32\x34.tfmodels.research.object_detection.protos.FlexibleGridAnchorGeneratorH\x00\x42\x18\n\x16\x61nchor_generator_oneof')
  ,
...
_ANCHORGENERATOR = _descriptor.Descriptor(
  ...
  full_name='tfmodels.research.object_detection.protos.AnchorGenerator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='grid_anchor_generator', full_name='tfmodels.research.object_detection.protos.AnchorGenerator.grid_anchor_generator', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='ssd_anchor_generator', full_name='tfmodels.research.object_detection.protos.AnchorGenerator.ssd_anchor_generator', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='multiscale_anchor_generator', full_name='tfmodels.research.object_detection.protos.AnchorGenerator.multiscale_anchor_generator', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flexible_grid_anchor_generator', full_name='tfmodels.research.object_detection.protos.AnchorGenerator.flexible_grid_anchor_generator', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='anchor_generator_oneof', full_name='tfmodels.research.object_detection.protos.AnchorGenerator.anchor_generator_oneof',
...
AnchorGenerator = _reflection.GeneratedProtocolMessageType('AnchorGenerator', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.anchor_generator_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.AnchorGenerator)
  ))

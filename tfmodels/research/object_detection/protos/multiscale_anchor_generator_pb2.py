...
_MULTISCALEANCHORGENERATOR = _descriptor.Descriptor(
  ...
  full_name='tfmodels.research.object_detection.protos.MultiscaleAnchorGenerator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_level', full_name='tfmodels.research.object_detection.protos.MultiscaleAnchorGenerator.min_level', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='max_level', full_name='tfmodels.research.object_detection.protos.MultiscaleAnchorGenerator.max_level', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='anchor_scale', full_name='tfmodels.research.object_detection.protos.MultiscaleAnchorGenerator.anchor_scale', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='aspect_ratios', full_name='tfmodels.research.object_detection.protos.MultiscaleAnchorGenerator.aspect_ratios', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='scales_per_octave', full_name='tfmodels.research.object_detection.protos.MultiscaleAnchorGenerator.scales_per_octave', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='normalize_coordinates', full_name='tfmodels.research.object_detection.protos.MultiscaleAnchorGenerator.normalize_coordinates', index=5,
...
MultiscaleAnchorGenerator = _reflection.GeneratedProtocolMessageType('MultiscaleAnchorGenerator', (_message.Message,), dict(
  ...
  __module__ = 'tfmodels.research.object_detection.protos.multiscale_anchor_generator_pb2'
  # @@protoc_insertion_point(class_scope:tfmodels.research.object_detection.protos.MultiscaleAnchorGenerator)
  ))
